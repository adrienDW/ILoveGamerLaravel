        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <h1>I Love Gamer Laravel</h1>
            </div>

            <div class="form-group">
                <label class="col-md-3 control-label">Saisir le nom du jeu : </label>
                <div class="col-md-5">
                    <form action="<?php echo e(route('postGame')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input row="2" name="nameGame" class="form-control"  autofocus/></input>
                        
                        <button type="submit"><a href="index.php/game" class="btn btn-primary">Valider</a>
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php $__currentLoopData = $UsersVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
                    <div class="container text-center">           
                        <div class="card" style="width: 18rem;">
                            <img src="<?php echo e($game->img); ?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo e($game->name); ?></h5>
                                <a href="./video-games/del/<?php echo e($game->id); ?>" class="btn btn-danger">Supprimer</a>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\ILoveGamerLaravel\resources\views/home.blade.php ENDPATH**/ ?>