    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                        <div class="container text-center">                            
                            <div class="card" style="width: 18rem;">
                                <form action="addFav" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <img src="<?php echo e($game->background_image); ?>" name="img" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title" name="nameGame"><?php echo e($game->name); ?></h5>
                                        <p class="card-text" name="release">Date de sortie : <?php echo e($game->released); ?></p>
                                        <?php if(auth()->guard()->check()): ?>
                                        <button type="submit" >
                                            <a href="./video-games/add/<?php echo e($game->id); ?>" class="btn btn-primary">Ajouter aux favoris</a>
                                        </button>
                                        <?php endif; ?>
                                    </div>
                                </form>
...
<?php /**PATH C:\laragon\www\ILoveGamerLaravel\resources\views/listOfGames.blade.php ENDPATH**/ ?>